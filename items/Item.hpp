...
namespace lce {
    ...
    public:
        ...
        constexpr ItemState(c_u16 id, c_u8 dataTag,
            ...
            m_typeAndArmor = (u8)itemType << 4 | (u8)armorType;
        }
        ...
        MU ND constexpr ItemType      getItemType()   const noexcept { return (ItemType)(m_typeAndArmor >> 4); }
        MU ND constexpr ItemEquipSlot getArmorType()  const noexcept { return (ItemEquipSlot)(m_typeAndArmor & 0x0F); }
        ...
        MU ItemState split(const i32 count) noexcept {
            ...
            splitItem.m_myItemCount = splitCount;
