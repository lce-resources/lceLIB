...
namespace lce::items {
    ...
    MU const Item IRON_SHOVEL = Item(256, 0, ItemType::ItemTool, "Iron Shovel", "iron_shovel", true);
    MU const Item IRON_PICKAXE = Item(257, 0, ItemType::ItemTool, "Iron Pickaxe", "iron_pickaxe", true);
    MU const Item IRON_AXE = Item(258, 0, ItemType::ItemTool, "Iron Axe", "iron_axe", true);
    MU const Item FLINT_AND_STEEL = Item(259, 0, ItemType::ItemTool, "Flint and Steel", "flint_and_steel", true);
    MU const Item APPLE = Item(260, 0, "Apple", "apple");
    MU const Item BOW = Item(261, 0, ItemType::ItemBow, "Bow", "bow");
    ...
    MU const Item IRON_SWORD = Item(267, 0, ItemType::ItemSword, "Iron Sword", "iron_sword", true);
    ...
    MU const Item FISHING_ROD = Item(346, 0, ItemType::ItemFishingRod, "Fishing Rod", "fishing_rod", true);
    ...
    MU const Item SHEARS = Item(359, 0, ItemType::ItemTool, "Shears", "shears", true);
    ...
    MU const Item ELYTRA = Item(443, 0, ItemType::ItemElytra, "Elytra", "elytra");
